...
export interface RetourExperienceDiagnostic {
  id: number;
  attributes: {
    createdAt: Date;    updatedAt: Date;    publishedAt?: Date;    image_principale?: { data: Media };
    titre: string;
    lieu: string;
    description: any;
    citations: Citation[];
...
export interface RetourExperienceDiagnostic_Plain {
  id: number;
  createdAt: Date;  updatedAt: Date;  publishedAt?: Date;  image_principale?: Media_Plain;
  titre: string;
  lieu: string;
  description: any;
...
export interface RetourExperienceDiagnostic_NoRelations {
  id: number;
  createdAt: Date;  updatedAt: Date;  publishedAt?: Date;  image_principale?: number;
  titre: string;
  lieu: string;
  description: any;
...
export interface RetourExperienceDiagnostic_AdminPanelLifeCycle {
  id: number;
  createdAt: Date;  updatedAt: Date;  publishedAt?: Date;  image_principale?: AdminPanelRelationPropertyModification<Media_Plain>;
  titre: string;
  lieu: string;
  description: any;
  citations: Citation_Plain[];
